...
wire [1:0]  wire_reg_addr_bytes;
wire [1:0]  wire_data_bytes;
...
i2c_register #(
    ...
    .reg_addr_bytes (wire_reg_addr_bytes),
    .data_bytes     (wire_data_bytes),
...
i2c_master i2c (
    ...
    // Backward-compatible single-byte ports
    .din            (wire_tx_data[7:0]),
    .dout           (),                   // not used
